    ...
    >
      <div className="flex h-9 items-center gap-2 px-1">
        <Button
          ...
          onClick={onBack}
          aria-label={t("agents.launcher.backAria")}
        >
        ...
        <div className="grid grid-cols-4 gap-1">
          {INSTANCE_COUNTS.map((count) => (
            <button
              ...
              aria-label={t(
                count === 1
                  ? "agents.launcher.instanceCountOne"
                  : "agents.launcher.instanceCountMany",
                { count },
              )}
      ...
      <div className="mt-3">
        <div className="mb-1.5 flex items-center">
          ...
          <button
            ...
            title={t("agents.launcher.resetTo", {
        ...
        >
          {validation.ok
            ? t("agents.launcher.aliasesSupported")
            : validation.error}
        </div>
      </div>
      ...
      >
        ...
        {t(
          instances === 1
            ? "agents.launcher.launchOne"
            : "agents.launcher.launchMany",
          { count: instances },
        )}
      </Button>
    </form>
