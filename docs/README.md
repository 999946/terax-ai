...
- [Plugin system](architecture/dcp-plugin-system.md) - user-level Node plugins, managed scripts, JSONL protocol, Space snapshots, lifecycle, and settings behavior.
